...
from aparent_data_plasmidDataset1 import load_data
from aparent_model_plasmid_large_lessdropoutOwn import load_aparent_model
...
plasmid_model_prefix, plasmid_model = load_aparent_model(batch_size, use_sample_weights=use_sample_weights)
...
tf.keras.utils.plot_model(plasmid_model, to_file='model.png', show_shapes=True)
...
plotScatterWithAxis(prediction, y_test, outputPath)